...
let allowedOrigins = ['http://localhost:8080', 'http://testsite.com', 'http://localhost:1234', 'https://my-flix-app83.netlify.app',
'https://my-flix-app83.netlify.app/login'];
app.use(cors());
...
app.get('/movies/directorInfo/:director', passport.authenticate('jwt', { session: false }), (req, res) => {
